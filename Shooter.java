    ...
    public boolean centerRobotOnTarget() {
        if (NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx").getDouble(0.0) < -20.0) {
            if (DriverStation.isTeleop()) {
                ...
                Robot.drive.driveTrainByControls(0.0, 0.0, -0.4, true);
            }
            return false;
            ...
            if (DriverStation.isTeleop()) {
                ...
                Robot.drive.driveTrainByControls(0.0, 0.0, -0.25, true);
            }
            return false;
        } else if (NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx")
                .getDouble(0.0) > 10.0) {
            ...
            if (DriverStation.isTeleop()) {
                ...
                Robot.drive.driveTrainByControls(0.0, 0.0, -0.15, true);
            }
            return false;
        } else if (NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx")
                .getDouble(0.0) > 6.0) {
            ...
            if (DriverStation.isTeleop()) {
                ...
                Robot.drive.driveTrainByControls(0.0, 0.0, -0.075, true);
            }
            return false;
        } else if (NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx")
                .getDouble(0.0) > 3.0) {
    ...
    public void shoot() {
        ...
        if (shooting && !dumpShot) {
            ...
            if (Math.abs(calculatedAngle - tempAngle) > 0.004) {
                ...
                if ((masterShooterMotor.getSelectedSensorVelocity() > (shooterWheelLinearVelocityToMotorVelocity(calculatedVelocity) * 1.009)) && setHoodYet) {
